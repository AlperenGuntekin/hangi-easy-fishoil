...
const EndScreen = () => {
  ...
  function EndScreen3(props) {
    return (
      ...
      <div className="text-lg text-left">
      Easyfishoil Multi ist unser Fischöl, welches leicht in der Anwendung ist und welches neben den Fettölen EPA und DHA Multivitamine enthält. Es ist ein Nahrungsergänzungsmittel, welches Sie
  
      bevorzugen können, wenn Sie die tägliche Nahrungszufuhr der Kinder unterstützen möchten. Easyfishoil Multi ist geeignet für die Nutzung von Kindern zwischen 3 und 10 Jahren.
      </div>
      <div className="space-y-4">
  ...
  function EndScreen4(props) {
    return (
      ...
      <div className="text-lg text-left">
      EasyFishoil Q ist unser Fischöl mit leichter Anwendung und welches zusätzlich zu den Fettsäuren EPA und DHA, Cholin, B6, B12 und Folsäure enthält. DHA unterstützt die normalen Gehirnfunktionen und schützt die normale Sehkraft. B6 und B12 unterstützen den normalen Stoffwechsel der Energieproduktion und unterstützt die Verringerung von Müdigkeit und Mattigkeit. Easyfishoil Q ist geeignet für die Nutzung von Kindern zwischen 4 und 10 Jahren.
      </div>
      <div className="space-y-4">
        <a href="https://easyfishoil.com/urunler/easyfishoil-q/" target="_blank">
          <button className="relative w-full text-white h-16 pt-1 px-5 text-xl rounded-full border-primary">Der Teil, wo Sie detaillierte Informationen erhalten.</button>
